                    ...
                    .then(() => {
                        channel.send({
                            embeds: [
                                ...
                                .setDescription(`• <@&1357161320679477459> rolü, ${member.displayName}'nın/nin durum mesajından \`${name}\` ifadesini kaldırdığı için kendisinden **alındı**.`)
                    ...
                    .then(() => {
                        channel.send({
                            embeds: [
                                ...
                                .setAuthor({ name: member.user.username, iconURL: member.user.displayAvatarURL() })    
                                .setDescription(`• <@&1357161320679477459> rolü, ${member.displayName}'nın/nin durum mesajını \`${name}\` yapması nedeniyle kendisine **verildi**.`)
                                .setThumbnail(member.user.displayAvatarURL())
                                .setFields([
                                    {
                                        name: 'Kullanıcı etiketi:',
